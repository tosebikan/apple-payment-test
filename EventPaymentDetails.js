    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.payment__info}>
        ...
        <Text style={styles.payment__infoText}>
          You are about to leave the app to go to an external event registration
          service.
        </Text>
      </View>
      <View style={styles.payment__info}>
        ...
        <Text style={styles.payment__infoText}>
          The event registration service does not unlock additional content
          within the app
        </Text>
      </View>
